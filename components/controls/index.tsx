...
export const Controls: ControlComponent = ({ clock, setClock }) => {
  const [showResetAfterControls, setShowResetAfterControls] = useState(false);
  return (
      ...
      >
        ...
        {clock.type !== 'clock' && (
          <RestartModeControl
            clock={clock}
            setClock={setClock}
            showResetAfterControls={showResetAfterControls}
            setShowResetAfterControls={setShowResetAfterControls}
          />
        )}
        {clock.type !== 'clock' &&
